...
Approximation schemes categorize algorithms based on their computational complexity, giving therefore a means of comparison between different approaches.
